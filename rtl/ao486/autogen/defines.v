...
`define CMD_IDIV 7'd110
`define CMD_OUT 7'd113
...
`define CMD_BSx 7'd68
`define CMD_CWD 7'd66
`define CMDEX_IN_idle 4'd3
`define CMD_CLTS 7'd77
`define CMDEX_int_STEP_0 4'd0
`define CMD_CALL_2 7'd99
`define CMD_CALL_3 7'd100
`define CMDEX_PUSH_MOV_SEG_implicit_TR 4'd7
`define CMD_BTx 7'd60
...
`define CMD_CPUID 7'd17
`define CMD_AND 7'd84
`define CMD_INVLPG 7'd71
`define CMDEX_STOS_STEP_0 4'd0
`define CMDEX_io_allow_1 4'd0
`define CMDEX_io_allow_2 4'd1
`define CMD_STOS 7'd47
...
`define CMD_BT 7'd60
`define CMD_POP_seg 7'd88
`define CMD_debug_reg 7'd53
...
`define CMD_LAHF 7'd64
`define CMD_VERR 7'd74
`define CMD_XCHG 7'd1
`define CMD_XADD 7'd79
`define CMD_LODS 7'd19
`define CMDEX_IMUL_modregrm 4'd0
`define CMDEX_int_2_int_trap_gate_same_STEP_4 4'd4
`define CMD_CLC 7'd30
...
`define CMD_WBINVD 7'd24
`define CMD_CMC 7'd32
`define CMDEX_POP_seg_STEP_LAST 4'd1
`define CMD_SIDT 7'd26
